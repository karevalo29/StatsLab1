...
randomization_test(A = group_1,
                   ...
                   resample=100)
```
The mean difference was 1.98 with a probability of 0. I would suggest that having a mean difference is actually not due to chance alone because i have a p value of 0 (but we should never say 0 so in this case it  just means really really small or less than .01)
